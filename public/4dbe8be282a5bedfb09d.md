...
tags:
  ...
  - fluentui
private: false
updated_at: '2026-06-22T18:49:48+09:00'
...
この記事では、まず Fluent UI 2 の位置づけを短く整理し、これまでの Fluent UI 2 シリーズをすべて紹介します。そのうえで、Fluent UI 2 の Popover usage と Fluent UI Blazor 5 の `FluentPopover` を比較し、使用法、機能差、使い分け、ガイドライン、レイアウト、アクセシビリティ、コンテンツ設計を整理します。特にガイドラインとコンテンツは重点的に扱います。
...
Popover で重要なのは、補助情報であることとフォーカス設計です。
